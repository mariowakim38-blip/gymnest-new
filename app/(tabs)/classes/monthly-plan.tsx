...
import { ChevronLeft, ChevronRight, CalendarDays, CheckCircle } from 'lucide-react-native';
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.hero}>
        ...
        <Text style={styles.heroTitle}>
          Build your child’s schedule
        </Text>
        <Text style={styles.heroSubtitle}>
          Choose a package, select weekly classes, then choose the start date.
        </Text>
      </View>
                    ...
                    {timeSlots.map((slot) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Text style={[styles.slotLevel, selected && styles.slotTextSelected]}>
                            {slot.level}
                          </Text>
                        </TouchableOpacity>
                      );
          ...
          <View style={styles.calendarCard}>
            ...
            <View style={styles.calendarGrid}>
              {calendarDates.map((date, index) => {
                ...
                const selected = formatLocalDate(date) === formatLocalDate(startDate);
